            ...
            if r.status_code == '200' or r.status_code == 200:
                ...
                if datas['offers'] == [] or datas['offers'] == '[]':
                    ...
                    for data in datas['offers']:
                        ...
                        advermodel.create_device_info(ad_id, device)
                        advermodel.create_Admix_advertise(ad_id, ader_id, data)
                    ...
                    message = {
                        'retcode': 0,
                        'retmsg': 'loading success'
                    }
                    self.write(message)

    @tornado.gen.coroutine
    def asyncRequest(self, url, params):
